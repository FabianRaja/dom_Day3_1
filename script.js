...
function navigation(direction) {
  if (direction === "previous" && currentPage>1) {
    ...
    currentPage=7;
  }else if(direction === "eigth" && currentPage !=8){
    currentPage=8;
...
document.querySelector("#prevPage").addEventListener("click", () => navigation("previous"));
document.querySelector("#nextPage").addEventListener("click", () => navigation("next"));
document.querySelector("#first").addEventListener("click", () =>navigation("first"));
document.querySelector("#second").addEventListener("click", () =>navigation("second"));
document.querySelector("#third").addEventListener("click", () =>navigation("third"));
document.querySelector("#fourth").addEventListener("click", () =>navigation("fourth"));
document.querySelector("#fifth").addEventListener("click", () =>navigation("fifth"));
document.querySelector("#sixth").addEventListener("click", () =>navigation("sixth"));
document.querySelector("#seventh").addEventListener("click", () =>navigation("seventh"));
document.querySelector("#eigth").addEventListener("click", () =>navigation("eigth"));
document.querySelector("#nineth").addEventListener("click", () =>navigation("nineth"));
document.querySelector("#tenth").addEventListener("click", () =>navigation("tenth"));
